...
const MainComponent = () => {
  return (
    <main className="sticky top-0 flex w-[55%] h-full min-h-screen flex-col border-l-[0.5px] border-r-[0.5px] border-gray-600">
      ...
      <div
        className="border-t-[0.5px] px-4 border-b-[0.5px] flex items-stretch py-6 space-x-2 border-gray-600
    relative"
      >
        ...
        <div className="flex flex-col w-full h-full">
          ...
          <div className="w-full justify-between items-center flex">
            ...
            <div className="w-full max-w-[100px]">
              <button
                className="rounded-full bg-primary px-4 py-2 w-full text-lg text-center hover:bg-primary/70 
            ...
            <div className="flex flex-col">
              <div className="flex items-center w-full justify-between">
                <div className="flex items-center space-x-1 w-full">
                  <div className="font-bold">Pick Plots</div>
                  <div className="text-gray-500">@PickPlots</div>
